  ...
  return (
    <section className="relative min-h-[85vh] overflow-hidden bg-zinc-950 text-white">
      ...
      <div className="relative mx-auto flex min-h-[85vh] max-w-6xl flex-col justify-center px-4 py-24 sm:px-6 sm:py-32">
        ...
        <h1 className="mt-4 max-w-4xl font-display text-5xl font-bold leading-[0.95] tracking-tight sm:text-6xl lg:text-7xl xl:text-8xl">
          {SITE.heroHeadline}
        </h1>
        <p className="mt-6 max-w-2xl text-xl leading-relaxed text-zinc-200 sm:text-2xl">
